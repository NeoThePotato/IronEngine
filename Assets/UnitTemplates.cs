...
namespace Assets
{
    static class UnitTemplates
	{
		...
		public static readonly Unit slime = new Unit("Slime", 2, 15, 1, 0.15f, 0.5f, 1f, Weapons.nothing, Armors.nothing, Armors.nothing);
		public static readonly Unit bandit = new Unit("Bandit", 5, 30, 2, 0.05f, 0.4f, 0.8f, Weapons.steelSword, Armors.rustedBuckler, Armors.leatherArmor);
