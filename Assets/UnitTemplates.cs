...
namespace Assets
{
	...
	{
		public static readonly Unit hero = new Unit("Hero", 1, 50, 5, 0.2f, 0.5f, 0.5f, Weapons.rustedBlade, Shields.rustedBuckler, BodyArmors.rustedChestplate, UNIT_PLAYER);
		...
		public static readonly Unit slime = new Unit("Slime", 1, 15, 1, 0.15f, 0.5f, 1f, Weapons.nothing, Shields.nothing, BodyArmors.nothing);
		...
		public static readonly Unit fae = new Unit("Fae", 2, 15, 1, 0.4f, 1f, 0.2f, Weapons.magicWand, Shields.nothing, BodyArmors.tatteredRags);
