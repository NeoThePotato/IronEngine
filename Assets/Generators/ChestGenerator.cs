...
{
	static class ChestGenerator
	{
		private static readonly Dictionary<Unit, SpawnProfile> SPAWNABLE_ITEMS = new Dictionary<Unit, SpawnProfile>()
		{
		...
		{
			return PickRandomUnitFromDict(FilterByLevel(SPAWNABLE_ITEMS, level));
		}
